...
<html>
        ...
        <body>
                ...
                //  restrictions.
                //  
                //  This example uses the property interface for setting up the chain of
                //  authenticators.
                // ==========================================================================
                ...
                use UUP\Authentication\Stack\AuthenticatorStack,
                    UUP\Authentication\Stack\Access\ChainPropertyAccess,
                ...
                class Authentication extends AuthenticatorStack
                {
                        ...
                        {
                                parent::__construct();
                                $chain = new ChainPropertyAccess($this);
