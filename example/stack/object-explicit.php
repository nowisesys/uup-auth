...
<html>
        ...
        <body>
                ...
                //  restrictions.
                //  
                //  This example is identical with object-explicit.php except for that it 
                //  uses the more standard way of initialization.
                // ==========================================================================
                ...
                class Authentication extends AuthenticatorStack
                {
                        ...
                        public function __construct()
                        {
                                $chain = array(
                                        ...
                                        // 
                                        'access' => array(
                                                'addr' => (new AddressAuthenticator(array('::1', '127.0.0.1', '192.168.0.0/16')))
                                                    ->visible(false)
